...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{listAll}: Führt \item \texttt{listAll} der Liste des Baumes aus.
        \item \texttt{count}: Führt \item \texttt{count} der Liste des Baumes aus.
        \item \texttt{first}: Führt \item \texttt{first} der Liste des Baumes aus.
        \item \texttt{last}: Führt \item \texttt{last} der Liste des Baumes aus.
        \item \texttt{isEmpty}: Führt \item \texttt{isEmpty} der Liste des Baumes aus.
        ...
        \item \texttt{bulkInsert}: Fügt mehrere Elemente auf einmal ein, als parallele Prozesse
    \end{itemize}
